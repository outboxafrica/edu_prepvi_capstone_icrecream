...
function purchaseClicked() {
    alert('Thank you for your purchase, please check your email for the receipt');
...
function updateCartTotal() {
    ...
    document.getElementsByClassName('cart-total-price')[0].innerText = 'shs' + total;
}
...
function deliverFood(){
    alert("Please check your email for details of delivery")
}
function myFunction() {
